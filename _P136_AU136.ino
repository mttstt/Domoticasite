...
// http://www.drhack.it/arduino/32-lettura-inverte-power-one-aurora.html

#define PLUGIN_136
#define PLUGIN_ID_136           136
#define PLUGIN_NAME_136         "Aurora Inverter - AU136 [TESTING]"
#define PLUGIN_VALUENAME1_136   "Energy"
#define PLUGIN_VALUENAME2_136   "Inverter"

boolean Plugin_136_init = false;
byte Plugin_MQ136_Inverter_= 0;
