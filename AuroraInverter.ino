...
const char* password = "999999999";//type your password
...
byte receiveAnswer() {
  ...
  if ((currentMillis - startMillis < timeout) and (recBuff[0] == 0)) {  // no timeout and transmission state is ok
    ...
    {
    Serial.println("Error Code - recBuff: ");
    Serial.print(recBuff[0]);
    Serial.print("");
    }
  else
 ...
 /* Serial.println("Values for Debugging: ");
  ...
  Serial.print("");
  Serial.print("Debug - *recBuff: ");
  Serial.print(*recBuff);
  Serial.print("");
  return(*recBuff);
}
