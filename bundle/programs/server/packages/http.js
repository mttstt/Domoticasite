...
HTTP = {}; /**                                                                                                         // 40
            ...
            * @param {String} url The URL to which the request should be sent.                                         // 42
            * @param {Object} [callOptions] Options passed on to [`HTTP.call`](#http_call).                            // 42
...
HTTP.get = function () /* varargs */{                                                                                  // 49
  return HTTP.call.apply(this, ["GET"].concat(_.toArray(arguments)));                                                  // 50
    ...
    * @param {String} url The URL to which the request should be sent.                                                 // 53
    * @param {Object} [callOptions] Options passed on to [`HTTP.call`](#http_call).                                    // 53
    * @param {Function} [asyncCallback] Callback that is called when the request is completed. Required on the client.
    * @locus Anywhere                                                                                                  // 53
    */                                                                                                                 // 53
                                                                                                                       // 53
HTTP.post = function () /* varargs */{                                                                                 // 60
  return HTTP.call.apply(this, ["POST"].concat(_.toArray(arguments)));                                                 // 61
    ...
    * @param {String} url The URL to which the request should be sent.                                                 // 64
    * @param {Object} [callOptions] Options passed on to [`HTTP.call`](#http_call).                                    // 64
    * @param {Function} [asyncCallback] Callback that is called when the request is completed. Required on the client.
    * @locus Anywhere                                                                                                  // 64
    */                                                                                                                 // 64
                                                                                                                       // 64
HTTP.put = function () /* varargs */{                                                                                  // 71
  return HTTP.call.apply(this, ["PUT"].concat(_.toArray(arguments)));                                                  // 72
    ...
    * @param {String} url The URL to which the request should be sent.                                                 // 75
    * @param {Object} [callOptions] Options passed on to [`HTTP.call`](#http_call).                                    // 75
    * @param {Function} [asyncCallback] Callback that is called when the request is completed. Required on the client.
    * @locus Anywhere                                                                                                  // 75
    */                                                                                                                 // 75
                                                                                                                       // 75
HTTP.del = function () /* varargs */{                                                                                  // 82
  return HTTP.call.apply(this, ["DELETE"].concat(_.toArray(arguments)));                                               // 83
    ...
    * @param {String} url The URL to which the request should be sent.                                                 // 86
    * @param {Object} [callOptions] Options passed on to [`HTTP.call`](#http_call).                                    // 86
    * @param {Function} [asyncCallback] Callback that is called when the request is completed. Required on the client.
    * @locus Anywhere                                                                                                  // 86
    */                                                                                                                 // 86
                                                                                                                       // 86
