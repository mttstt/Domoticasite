...
var Cursor = function () {                                                                                             // 1
  ...
  function Cursor(collection, selector) {                                                                              // 8
     ...
     * @summary Returns the number of documents that match a query.                                                    // 43
     * @memberOf Mongo.Cursor                                                                                          // 43
     * @method  count                                                                                                  // 43
     * @instance                                                                                                       // 43
     * @locus Anywhere                                                                                                 // 43
     * @returns {Number}                                                                                               // 43
     */                                                                                                                // 43
                                                                                                                       // 43
  Cursor.prototype.count = function () {                                                                               // 43
    function count() {                                                                                                 //
      if (this.reactive) {                                                                                             // 52
    ...
    return count;                                                                                                      // 58
        ...
        * @summary Return all matching documents as an Array.                                                          // 60
        * @memberOf Mongo.Cursor                                                                                       // 60
        * @method  fetch                                                                                               // 60
        * @instance                                                                                                    // 60
        * @locus Anywhere                                                                                              // 60
        * @returns {Object[]}                                                                                          // 60
        */                                                                                                             // 60
                                                                                                                       // 60
  Cursor.prototype.fetch = function () {                                                                               // 60
    function fetch() {                                                                                                 //
      var result = [];                                                                                                 // 69
    ...
    return fetch;                                                                                                      // 76
                                                                                                                       ...
                                                                                                                       // 76
  Cursor.prototype[Symbol.iterator] = function () {                                                                    // 76
    var _this = this;                                                                                                  // 78
                                                                                                                       // 78
    if (this.reactive) {                                                                                               // 79
      this._depend({                                                                                                   // 80
    ...
    return {                                                                                                           // 90
      ...
      * @callback IterationCallback                                                                                    // 107
      * @param {Object} doc                                                                                            // 107
      * @param {Number} index                                                                                          // 107
      */ /**                                                                                                           // 107
          * @summary Call `callback` once for each matching document, sequentially and                                 // 112
          *          synchronously.                                                                                    // 112
          * @locus Anywhere                                                                                            // 112
          * @method  forEach                                                                                           // 112
          * @instance                                                                                                  // 112
          * @memberOf Mongo.Cursor                                                                                     // 112
          * @param {IterationCallback} callback Function to call. It will be called                                    // 112
          *                                     with three arguments: the document, a                                  // 112
          *                                     0-based index, and <em>cursor</em>                                     // 112
          *                                     itself.                                                                // 112
          * @param {Any} [thisArg] An object which will be the value of `this` inside                                  // 112
          *                        `callback`.                                                                         // 112
          */                                                                                                           // 112
                                                                                                                       // 112
  Cursor.prototype.forEach = function () {                                                                             // 112
    ...
    return forEach;                                                                                                    // 145
                                                                                                                       ...
                                                                                                                       // 145
  Cursor.prototype.getTransform = function () {                                                                        // 145
    function getTransform() {                                                                                          //
      return this._transform;                                                                                          // 148
    }                                                                                                                  // 149
                                                                                                                       // 149
    return getTransform;                                                                                               // 149
  }(); /**                                                                                                             // 149
        * @summary Map callback over all matching documents.  Returns an Array.                                        // 151
        * @locus Anywhere                                                                                              // 151
        * @method map                                                                                                  // 151
        * @instance                                                                                                    // 151
        * @memberOf Mongo.Cursor                                                                                       // 151
        * @param {IterationCallback} callback Function to call. It will be called                                      // 151
        *                                     with three arguments: the document, a                                    // 151
        *                                     0-based index, and <em>cursor</em>                                       // 151
        *                                     itself.                                                                  // 151
        * @param {Any} [thisArg] An object which will be the value of `this` inside                                    // 151
        *                        `callback`.                                                                           // 151
        */                                                                                                             // 151
                                                                                                                       // 151
  Cursor.prototype.map = function () {                                                                                 // 151
  ...
  /**                                                                                                                  // 195
   * @summary Watch a query.  Receive callbacks as the result set changes.                                             // 195
   * @locus Anywhere                                                                                                   // 195
   * @memberOf Mongo.Cursor                                                                                            // 195
   * @instance                                                                                                         // 195
   * @param {Object} callbacks Functions to call to deliver the result set as it                                       // 195
   *                           changes                                                                                 // 195
   */                                                                                                                  // 195
                                                                                                                       // 195
  Cursor.prototype.observe = function () {                                                                             // 195
    ...
    return observe;                                                                                                    // 205
        ...
        * @summary Watch a query. Receive callbacks as the result set changes. Only                                    // 207
        *          the differences between the old and new documents are passed to                                     // 207
        *          the callbacks.                                                                                      // 207
        * @locus Anywhere                                                                                              // 207
        * @memberOf Mongo.Cursor                                                                                       // 207
        * @instance                                                                                                    // 207
        * @param {Object} callbacks Functions to call to deliver the result set as it                                  // 207
        *                           changes                                                                            // 207
        */                                                                                                             // 207
                                                                                                                       // 207
  Cursor.prototype.observeChanges = function () {                                                                      // 207
    function observeChanges(options) {                                                                                 //
      ...
      return handle;                                                                                                   // 343
                                                                                                                       ...
                                                                                                                       // 344
    return observeChanges;                                                                                             // 344
  }(); // Since we don't actually have a "nextObject" interface, there's really no                                     // 344
  ...
  // XXX COMPAT WITH 0.8.1                                                                                             // 349
                                                                                                                       // 349
                                                                                                                       // 349
  Cursor.prototype.rewind = function () {                                                                              // 349
    function rewind() {}                                                                                               //
                                                                                                                       // 350
    return rewind;                                                                                                     // 350
  }(); // XXX Maybe we need a version of observe that just calls a callback if                                         // 350
  // anything changed.                                                                                                 // 353
                                                                                                                       // 353
                                                                                                                       // 353
  Cursor.prototype._depend = function () {                                                                             // 353
    ...
    return _depend;                                                                                                    // 373
                                                                                                                       ...
                                                                                                                       // 373
  Cursor.prototype._getCollectionName = function () {                                                                  // 373
    function _getCollectionName() {                                                                                    //
      return this.collection.name;                                                                                     // 376
    }                                                                                                                  // 377
                                                                                                                       // 377
    return _getCollectionName;                                                                                         // 377
  }(); // Returns a collection of matching objects, but doesn't deep copy them.                                        // 377
  //                                                                                                                   // 380
  ...
  // returns.                                                                                                          // 394
                                                                                                                       // 394
                                                                                                                       // 394
  Cursor.prototype._getRawObjects = function () {                                                                      // 394
    function _getRawObjects() {                                                                                        //
      ...
      return results.slice(this.skip, this.limit ? this.limit + this.skip : results.length);                           // 474
                                                                                                                       ...
                                                                                                                       // 478
    return _getRawObjects;                                                                                             // 478
  }();                                                                                                                 // 478
                                                                                                                       // 478
  Cursor.prototype._publishCursor = function () {                                                                      // 478
...
module.watch(require("./common.js"), {                                                                                 // 1
  ...
  projectionDetails: function (v) {                                                                                    // 1
    projectionDetails = v;                                                                                             // 1
                                                                                                                       ...
                                                                                                                       // 1
var LocalCollection = function () {                                                                                    // 1
  ...
  // XXX tests                                                                                                         // 59
                                                                                                                       // 59
                                                                                                                       // 59
  LocalCollection.prototype.find = function () {                                                                       // 59
    ...
    return find;                                                                                                       // 69
                                                                                                                       ...
                                                                                                                       // 69
  LocalCollection.prototype.findOne = function () {                                                                    // 69
    function findOne(selector) {                                                                                       //
      ...
      return this.find(selector, options).fetch()[0];                                                                  // 86
                                                                                                                       ...
                                                                                                                       // 87
    return findOne;                                                                                                    // 87
  }(); // XXX possibly enforce that 'undefined' does not appear (we assume                                             // 87
  // this in our handling of null and $exists)                                                                         // 90
                                                                                                                       // 90
                                                                                                                       // 90
  LocalCollection.prototype.insert = function () {                                                                     // 90
    function insert(doc, callback) {                                                                                   //
      ...
      return id;                                                                                                       // 152
                                                                                                                       ...
                                                                                                                       // 153
    return insert;                                                                                                     // 153
  }(); // Pause the observers. No callbacks from observers will fire until                                             // 153
  // 'resumeObservers' is called.                                                                                      // 156
                                                                                                                       // 156
                                                                                                                       // 156
  LocalCollection.prototype.pauseObservers = function () {                                                             // 156
    function pauseObservers() {                                                                                        //
      ...
      Object.keys(this.queries).forEach(function (qid) {                                                               // 167
        ...
        query.resultsSnapshot = EJSON.clone(query.results);                                                            // 169
                                                                                                                       ...
                                                                                                                       // 171
    return pauseObservers;                                                                                             // 171
  }();                                                                                                                 // 171
                                                                                                                       // 171
  LocalCollection.prototype.remove = function () {                                                                     // 171
    function remove(selector, callback) {                                                                              //
      ...
      return result;                                                                                                   // 265
                                                                                                                       ...
                                                                                                                       // 266
    return remove;                                                                                                     // 266
  }(); // Resume the observers. Observers immediately receive change                                                   // 266
  ...
  // happened during the pause, it is a smarter 'coalesced' diff.                                                      // 271
                                                                                                                       // 271
                                                                                                                       // 271
  LocalCollection.prototype.resumeObservers = function () {                                                            // 271
    function resumeObservers() {                                                                                       //
      ...
      this._observeQueue.drain();                                                                                      // 306
                                                                                                                       ...
                                                                                                                       // 307
    return resumeObservers;                                                                                            // 307
  }();                                                                                                                 // 307
                                                                                                                       // 307
  LocalCollection.prototype.retrieveOriginals = function () {                                                          // 307
    function retrieveOriginals() {                                                                                     //
      ...
      return originals;                                                                                                // 318
                                                                                                                       ...
                                                                                                                       // 319
    return retrieveOriginals;                                                                                          // 319
  }(); // To track what documents are affected by a piece of code, call                                                // 319
  ...
  // between calls to saveOriginals() and retrieveOriginals().                                                         // 327
                                                                                                                       // 327
                                                                                                                       // 327
  LocalCollection.prototype.saveOriginals = function () {                                                              // 327
    function saveOriginals() {                                                                                         //
      ...
      this._savedOriginals = new LocalCollection._IdMap();                                                             // 333
                                                                                                                       ...
                                                                                                                       // 334
    return saveOriginals;                                                                                              // 334
  }(); // XXX atomicity: if multi is true, and one modification fails, do                                              // 334
  // we rollback the whole operation, or what?                                                                         // 337
                                                                                                                       // 337
                                                                                                                       // 337
  LocalCollection.prototype.update = function () {                                                                     // 337
    function update(selector, mod, options, callback) {                                                                //
      ...
      return result;                                                                                                   // 474
                                                                                                                       ...
                                                                                                                       // 475
    return update;                                                                                                     // 475
  }(); // A convenience wrapper on update. LocalCollection.upsert(sel, mod) is                                         // 475
  // equivalent to LocalCollection.update(sel, mod, {upsert: true,                                                     // 478
  // _returnObject: true}).                                                                                            // 479
                                                                                                                       // 479
                                                                                                                       // 479
  LocalCollection.prototype.upsert = function () {                                                                     // 479
    function upsert(selector, mod, options, callback) {                                                                //
      ...
      return this.update(selector, mod, Object.assign({}, options, {                                                   // 486
        ...
        _returnObject: true                                                                                            // 489
                                                                                                                       ...
                                                                                                                       // 492
    return upsert;                                                                                                     // 492
  }(); // Iterates over a subset of documents that could match selector; calls                                         // 492
  ...
  // same object that is in _docs.                                                                                     // 497
                                                                                                                       // 497
                                                                                                                       // 497
  LocalCollection.prototype._eachPossiblyMatchingDoc = function () {                                                   // 497
    function _eachPossiblyMatchingDoc(selector, fn) {                                                                  //
      ...
      if (specificIds) {                                                                                               // 501
        ...
        this._docs.forEach(fn);                                                                                        // 510
                                                                                                                       ...
                                                                                                                       // 512
    return _eachPossiblyMatchingDoc;                                                                                   // 512
  }();                                                                                                                 // 512
                                                                                                                       // 512
  LocalCollection.prototype._modifyAndNotify = function () {                                                           // 512
      ...
      Object.keys(this.queries).forEach(function (qid) {                                                               // 537
        ...
        if (query.cursor.skip || query.cursor.limit) {                                                                 // 552
          ...
          LocalCollection._updateInResults(query, doc, old_doc);                                                       // 568
                                                                                                                       ...
                                                                                                                       // 571
    return _modifyAndNotify;                                                                                           // 571
  }(); // Recomputes the results of a query and runs observe callbacks for the                                         // 571
  ...
  // oldResults is guaranteed to be ignored if the query is not paused.                                                // 583
                                                                                                                       // 583
                                                                                                                       // 583
  LocalCollection.prototype._recomputeResults = function () {                                                          // 583
      ...
      if (!this.paused) {                                                                                              // 606
        LocalCollection._diffQueryChanges(query.ordered, oldResults, query.results, query, {                           // 607
          projectionFn: query.projectionFn                                                                             // 612
                                                                                                                       ...
                                                                                                                       // 615
    return _recomputeResults;                                                                                          // 615
  }();                                                                                                                 // 615
                                                                                                                       // 615
  LocalCollection.prototype._saveOriginal = function () {                                                              // 615
    function _saveOriginal(id, doc) {                                                                                  //
      ...
      this._savedOriginals.set(id, EJSON.clone(doc));                                                                  // 630
                                                                                                                       ...
                                                                                                                       // 631
    return _saveOriginal;                                                                                              // 631
  }();                                                                                                                 // 631
                                                                                                                       // 631
  return LocalCollection;                                                                                              // 631
}();                                                                                                                   // 631
                                                                                                                       // 631
...
var Matcher = function () {                                                                                            // 1
  function Matcher(selector, isUpdate) {                                                                               // 29
    ...
    this._isUpdate = isUpdate;                                                                                         // 54
                                                                                                                       ...
                                                                                                                       // 55
  Matcher.prototype.documentMatches = function () {                                                                    // 55
    function documentMatches(doc) {                                                                                    //
      ...
      return this._docMatcher(doc);                                                                                    // 62
                                                                                                                       ...
                                                                                                                       // 63
    return documentMatches;                                                                                            // 63
  }();                                                                                                                 // 63
                                                                                                                       // 63
  Matcher.prototype.hasGeoQuery = function () {                                                                        // 63
    function hasGeoQuery() {                                                                                           //
      return this._hasGeoQuery;                                                                                        // 66
    }                                                                                                                  // 67
                                                                                                                       // 67
    return hasGeoQuery;                                                                                                // 67
  }();                                                                                                                 // 67
                                                                                                                       // 67
  Matcher.prototype.hasWhere = function () {                                                                           // 67
    function hasWhere() {                                                                                              //
    ...
    return hasWhere;                                                                                                   // 71
                                                                                                                       ...
                                                                                                                       // 71
  Matcher.prototype.isSimple = function () {                                                                           // 71
    function isSimple() {                                                                                              //
      return this._isSimple;                                                                                           // 74
    }                                                                                                                  // 75
                                                                                                                       // 75
    return isSimple;                                                                                                   // 75
  }(); // Given a selector, return a function that takes one argument, a                                               // 75
  // document. It returns a result object.                                                                             // 78
                                                                                                                       // 78
                                                                                                                       // 78
  Matcher.prototype._compileSelector = function () {                                                                   // 78
    function _compileSelector(selector) {                                                                              //
      ...
      return compileDocumentSelector(selector, this, {                                                                 // 114
        isRoot: true                                                                                                   // 114
                                                                                                                       ...
                                                                                                                       // 115
    return _compileSelector;                                                                                           // 115
  }(); // Returns a list of key paths the given selector is looking for. It includes                                   // 115
  // the empty string if there is a $where.                                                                            // 118
                                                                                                                       // 118
                                                                                                                       // 118
  Matcher.prototype._getPaths = function () {                                                                          // 118
    function _getPaths() {                                                                                             //
      return Object.keys(this._paths);                                                                                 // 120
    }                                                                                                                  // 121
                                                                                                                       // 121
    return _getPaths;                                                                                                  // 121
  }();                                                                                                                 // 121
                                                                                                                       // 121
  Matcher.prototype._recordPathUsed = function () {                                                                    // 121
    function _recordPathUsed(path) {                                                                                   //
      this._paths[path] = true;                                                                                        // 124
    }                                                                                                                  // 125
                                                                                                                       // 125
    return _recordPathUsed;                                                                                            // 125
  }();                                                                                                                 // 125
                                                                                                                       // 125
  return Matcher;                                                                                                      // 125
}();                                                                                                                   // 125
...
var Sorter = function () {                                                                                             // 1
  function Sorter(spec) {                                                                                              // 25
    ...
    if (options.matcher) {                                                                                             // 91
      this._useWithMatcher(options.matcher);                                                                           // 92
                                                                                                                       ...
                                                                                                                       // 94
  Sorter.prototype.getComparator = function () {                                                                       // 94
    function getComparator(options) {                                                                                  //
      ...
      return function (a, b) {                                                                                         // 109
        ...
        return distances.get(a._id) - distances.get(b._id);                                                            // 118
                                                                                                                       ...
                                                                                                                       // 120
    return getComparator;                                                                                              // 120
  }(); // Takes in two keys: arrays whose lengths match the number of spec                                             // 120
  // parts. Returns negative, 0, or positive based on using the sort spec to                                           // 123
  // compare fields.                                                                                                   // 124
                                                                                                                       // 124
                                                                                                                       // 124
  Sorter.prototype._compareKeys = function () {                                                                        // 124
    function _compareKeys(key1, key2) {                                                                                //
      ...
      return this._keyComparator(key1, key2);                                                                          // 131
                                                                                                                       ...
                                                                                                                       // 132
    return _compareKeys;                                                                                               // 132
  }(); // Iterates over each possible "key" from doc (ie, over each branch), calling                                   // 132
  // 'cb' with the key.                                                                                                // 135
                                                                                                                       // 135
                                                                                                                       // 135
  Sorter.prototype._generateKeysFromDoc = function () {                                                                // 135
    function _generateKeysFromDoc(doc, cb) {                                                                           //
      ...
      Object.keys(knownPaths).forEach(function (path) {                                                                // 231
        ...
        cb(key);                                                                                                       // 244
                                                                                                                       ...
                                                                                                                       // 246
    return _generateKeysFromDoc;                                                                                       // 246
  }(); // Returns a comparator that represents the sort specification (but not                                         // 246
  // including a possible geoquery distance tie-breaker).                                                              // 249
                                                                                                                       // 249
                                                                                                                       // 249
  Sorter.prototype._getBaseComparator = function () {                                                                  // 249
    function _getBaseComparator() {                                                                                    //
      ...
      return function (doc1, doc2) {                                                                                   // 261
        ...
        return _this2._compareKeys(key1, key2);                                                                        // 264
                                                                                                                       ...
                                                                                                                       // 266
    return _getBaseComparator;                                                                                         // 266
  }(); // Finds the minimum key from the doc, according to the sort specs.  (We say                                    // 266
  ...
  // [1,3], and the minimum key is [0,5]; notably, [0,3] is NOT a key.                                                 // 277
                                                                                                                       // 277
                                                                                                                       // 277
  Sorter.prototype._getMinKeyFromDoc = function () {                                                                   // 277
    function _getMinKeyFromDoc(doc) {                                                                                  //
      ...
      return minKey;                                                                                                   // 302
                                                                                                                       ...
                                                                                                                       // 303
    return _getMinKeyFromDoc;                                                                                          // 303
  }();                                                                                                                 // 303
                                                                                                                       // 303
  Sorter.prototype._getPaths = function () {                                                                           // 303
    function _getPaths() {                                                                                             //
      return this._sortSpecParts.map(function (part) {                                                                 // 306
        return part.path;                                                                                              // 306
                                                                                                                       ...
                                                                                                                       // 307
    return _getPaths;                                                                                                  // 307
  }();                                                                                                                 // 307
                                                                                                                       // 307
  Sorter.prototype._keyCompatibleWithSelector = function () {                                                          // 307
    function _keyCompatibleWithSelector(key) {                                                                         //
      return !this._keyFilter || this._keyFilter(key);                                                                 // 310
    }                                                                                                                  // 311
                                                                                                                       // 311
    return _keyCompatibleWithSelector;                                                                                 // 311
  }(); // Given an index 'i', returns a comparator that compares two key arrays based                                  // 311
  // on field 'i'.                                                                                                     // 314
                                                                                                                       // 314
                                                                                                                       // 314
  Sorter.prototype._keyFieldComparator = function () {                                                                 // 314
    function _keyFieldComparator(i) {                                                                                  //
      ...
      return function (key1, key2) {                                                                                   // 318
        ...
        return invert ? -compare : compare;                                                                            // 320
                                                                                                                       ...
                                                                                                                       // 322
    return _keyFieldComparator;                                                                                        // 322
  }(); // In MongoDB, if you have documents                                                                            // 322
  ...
  // on our understanding of Mongo's behavior.                                                                         // 342
                                                                                                                       // 342
                                                                                                                       // 342
  Sorter.prototype._useWithMatcher = function () {                                                                     // 342
