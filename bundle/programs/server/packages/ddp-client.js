...
_.extend(Connection.prototype, {                                                                                       // 478
  ...
  /**                                                                                                                  // 516
   * @memberOf Meteor                                                                                                  // 516
   * @importFromPackage meteor                                                                                         // 516
   * @summary Subscribe to a record set.  Returns a handle that provides                                               // 516
   * `stop()` and `ready()` methods.                                                                                   // 516
   * @locus Client                                                                                                     // 516
   * @param {String} name Name of the subscription.  Matches the name of the                                           // 516
   * server's `publish()` call.                                                                                        // 516
   * @param {EJSONable} [arg1,arg2...] Optional arguments passed to publisher                                          // 516
   * function on server.                                                                                               // 516
   * @param {Function|Object} [callbacks] Optional. May include `onStop`                                               // 516
   * and `onReady` callbacks. If there is an error, it is passed as an                                                 // 516
   * argument to `onStop`. If a function is passed instead of an object, it                                            // 516
   * is interpreted as an `onReady` callback.                                                                          // 516
   */subscribe: function (name /* .. [arguments] .. (callback|callbacks) */) {                                         // 516
    var self = this;                                                                                                   // 532
  ...
  /**                                                                                                                  // 715
   * @memberOf Meteor                                                                                                  // 715
   * @importFromPackage meteor                                                                                         // 715
   * @summary Invokes a method passing any number of arguments.                                                        // 715
   * @locus Anywhere                                                                                                   // 715
   * @param {String} name Name of method to invoke                                                                     // 715
   * @param {EJSONable} [arg1,arg2...] Optional method arguments                                                       // 715
   * @param {Function} [asyncCallback] Optional callback, which is called asynchronously with the error or result after the method is complete. If not provided, the method runs synchronously if possible (see below).
   */call: function (name /* .. [arguments] .. callback */) {                                                          // 715
  ...
  /**                                                                                                                  // 754
   * @memberOf Meteor                                                                                                  // 754
   * @importFromPackage meteor                                                                                         // 754
   * @summary Invoke a method passing an array of arguments.                                                           // 754
   * @locus Anywhere                                                                                                   // 754
   * @param {String} name Name of method to invoke                                                                     // 754
   * @param {EJSONable[]} args Method arguments                                                                        // 754
   * @param {Object} [options]                                                                                         // 754
   ...
   * @param {Function} [asyncCallback] Optional callback; same semantics as in [`Meteor.call`](#meteor_call).          // 754
   */apply: function (name, args, options, callback) {                                                                 // 754
  ...
  /**                                                                                                                  // 1056
   * @summary Get the current connection status. A reactive data source.                                               // 1056
   * @locus Client                                                                                                     // 1056
   * @memberOf Meteor                                                                                                  // 1056
   * @importFromPackage meteor                                                                                         // 1056
   */status: function () /*passthrough args*/{                                                                         // 1056
    var self = this;                                                                                                   // 1063
    return self._stream.status.apply(self._stream, arguments);                                                         // 1064
  },                                                                                                                   // 1065
  /**                                                                                                                  // 1067
   * @summary Force an immediate reconnection attempt if the client is not connected to the server.                    // 1067
   This method does nothing if the client is already connected.                                                        // 1067
   * @locus Client                                                                                                     // 1067
   * @memberOf Meteor                                                                                                  // 1067
   * @importFromPackage meteor                                                                                         // 1067
   */reconnect: function () /*passthrough args*/{                                                                      // 1067
    var self = this;                                                                                                   // 1076
    return self._stream.reconnect.apply(self._stream, arguments);                                                      // 1077
  },                                                                                                                   // 1078
  /**                                                                                                                  // 1080
   * @summary Disconnect the client from the server.                                                                   // 1080
   * @locus Client                                                                                                     // 1080
   * @memberOf Meteor                                                                                                  // 1080
   * @importFromPackage meteor                                                                                         // 1080
   */disconnect: function () /*passthrough args*/{                                                                     // 1080
    var self = this;                                                                                                   // 1087
 ...
 * @locus Anywhere                                                                                                     // 1753
 * @param {String} url The URL of another Meteor application.                                                          // 1753
 */                                                                                                                    // 1753
                                                                                                                       // 1753
...
DDP._reconnectHook = new Hook({                                                                                        // 1764
  bindEnvironment: false                                                                                               // 1764
     ...
     * @summary Register a function to call as the first step of                                                       // 1766
     * reconnecting. This function can call methods which will be executed before                                      // 1766
     * any other outstanding methods. For example, this can be used to re-establish                                    // 1766
     * the appropriate authentication context on the connection.                                                       // 1766
     * @locus Anywhere                                                                                                 // 1766
     * @param {Function} callback The function to call. It will be called with a                                       // 1766
     * single argument, the [connection object](#ddp_connect) that is reconnecting.                                    // 1766
     */                                                                                                                // 1766
                                                                                                                       // 1766
...
module.export({                                                                                                        // 1
  MongoIDMap: function () {                                                                                            // 1
    return MongoIDMap;                                                                                                 // 1
                                                                                                                       ...
                                                                                                                       // 1
var MongoIDMap = function (_IdMap) {                                                                                   // 1
