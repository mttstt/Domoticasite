...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }                      //
                                                                                                                       //
/**                                                                                                                    // 1
 * Provide a synchronous Collection API using fibers, backed by                                                        // 1
 * MongoDB.  This is only for use on the server, and mostly identical                                                  // 1
 * to the client API.                                                                                                  // 1
 *                                                                                                                     // 1
 * NOTE: the public API methods must be run within a fiber. If you call                                                // 1
 * these outside of a fiber they will explode!                                                                         // 1
 */var MongoDB = NpmModuleMongodb;                                                                                     // 1
                                                                                                                       // 10
...
/**                                                                                                                    // 4
 * @summary Namespace for MongoDB-related items                                                                        // 4
 * @namespace                                                                                                          // 4
 */Mongo = {}; /**                                                                                                     // 4
                * @summary Constructor for a Collection                                                                // 10
                * @locus Anywhere                                                                                      // 10
                * @instancename collection                                                                             // 10
                * @class                                                                                               // 10
                ...
                * @param {String} options.idGeneration The method of generating the `_id` fields of new documents in this collection.  Possible values:
                                                                                                                       // 10
                - **`'STRING'`**: random strings                                                                       // 10
                - **`'MONGO'`**:  random [`Mongo.ObjectID`](#mongo_object_id) values                                   // 10
                                                                                                                       // 10
               The default id generation technique is `'STRING'`.                                                      // 10
...
_.extend(Mongo.Collection.prototype, {                                                                                 // 258
  ...
  /**                                                                                                                  // 285
   * @summary Find the documents in a collection that match the selector.                                              // 285
   * @locus Anywhere                                                                                                   // 285
   * @method find                                                                                                      // 285
   * @memberOf Mongo.Collection                                                                                        // 285
   * @instance                                                                                                         // 285
   * @param {MongoSelector} [selector] A query describing the documents to find                                        // 285
   ...
   * @param {Number} options.limit Maximum number of results to return                                                 // 285
   * @param {MongoFieldSpecifier} options.fields Dictionary of fields to return or exclude.                            // 285
   * @param {Boolean} options.reactive (Client only) Default `true`; pass `false` to disable reactivity                // 285
   ...
   * @returns {Mongo.Cursor}                                                                                           // 285
   */find: function () /* selector, options */{                                                                        // 285
   ...
   * @locus Anywhere                                                                                                   // 316
   * @method findOne                                                                                                   // 316
   * @memberOf Mongo.Collection                                                                                        // 316
   * @instance                                                                                                         // 316
   * @param {MongoSelector} [selector] A query describing the documents to find                                        // 316
   * @param {Object} [options]                                                                                         // 316
   * @param {MongoSortSpecifier} options.sort Sort order (default: natural order)                                      // 316
   * @param {Number} options.skip Number of results to skip at the beginning                                           // 316
   * @param {MongoFieldSpecifier} options.fields Dictionary of fields to return or exclude.                            // 316
   * @param {Boolean} options.reactive (Client only) Default true; pass false to disable reactivity                    // 316
   * @param {Function} options.transform Overrides `transform` on the [`Collection`](#collections) for this cursor.  Pass `null` to disable transformation.
   * @returns {Object}                                                                                                 // 316
   */findOne: function () /* selector, options */{                                                                     // 316
    var self = this;                                                                                                   // 332
                                                                                                                       // 332
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                       //
/**                                                                                                                    // 1
 * @summary Allows for user specified connection options                                                               // 1
 * @example http://mongodb.github.io/node-mongodb-native/2.2/reference/connecting/connection-settings/                 // 1
 * @locus Server                                                                                                       // 1
 * @param {Object} options User specified Mongo connection options                                                     // 1
 */Mongo.setConnectionOptions = function () {                                                                          // 1
