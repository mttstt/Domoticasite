...
_.extend(SessionDocumentView.prototype, {                                                                             // 24
  ...
  changeField: function (subscriptionHandle, key, value, changeCollector, isAdd) {                                    // 68
     ...
     * Represents a client's view of a single collection                                                              // 106
     * @param {String} collectionName Name of the collection it represents                                            // 106
     * @param {Object.<String, Function>} sessionCallbacks The callbacks for added, changed, removed                  // 106
     * @class SessionCollectionView                                                                                   // 106
     */                                                                                                               // 106
                                                                                                                      // 106
...
// publish                                                                                                            // 949
/**                                                                                                                   // 950
 * @summary The server's side of a subscription                                                                       // 950
 * @class Subscription                                                                                                // 950
 * @instanceName this                                                                                                 // 950
 * @showInstanceName true                                                                                             // 950
 */                                                                                                                   // 950
                                                                                                                      // 950
var Subscription = function (session, handler, subscriptionId, params, name) {                                        // 956
  ...
  /**                                                                                                                 // 1003
   * @summary Access inside the publish function. The id of the logged-in user, or `null` if no user is logged in.    // 1003
   * @locus Server                                                                                                    // 1003
   * @memberOf Subscription                                                                                           // 1003
   * @name  userId                                                                                                    // 1003
   * @instance                                                                                                        // 1003
   */                                                                                                                 // 1003
...
_.extend(Subscription.prototype, {                                                                                    // 1030
   ...
   * @locus Server                                                                                                    // 1185
   * @param {Error} error The error to pass to the client.                                                            // 1185
   * @instance                                                                                                        // 1185
   * @memberOf Subscription                                                                                           // 1185
   */error: function (error) {                                                                                        // 1185
    var self = this;                                                                                                  // 1193
   ...
   * @locus Server                                                                                                    // 1217
   * @memberOf Subscription                                                                                           // 1217
   * @instance                                                                                                        // 1217
   * @param {Function} func The callback function                                                                     // 1217
   */onStop: function (callback) {                                                                                    // 1217
    var self = this;                                                                                                  // 1225
   ...
   * @locus Server                                                                                                    // 1241
   * @memberOf Subscription                                                                                           // 1241
   * @instance                                                                                                        // 1241
   * @param {String} collection The name of the collection that contains the new document.                            // 1241
   * @param {String} id The new document's ID.                                                                        // 1241
   * @param {Object} fields The fields in the new document.  If `_id` is present it is ignored.                       // 1241
   */added: function (collectionName, id, fields) {                                                                   // 1241
    var self = this;                                                                                                  // 1251
   ...
   * @locus Server                                                                                                    // 1259
   * @memberOf Subscription                                                                                           // 1259
   * @instance                                                                                                        // 1259
   * @param {String} collection The name of the collection that contains the changed document.                        // 1259
   * @param {String} id The changed document's ID.                                                                    // 1259
   * @param {Object} fields The fields in the document that have changed, together with their new values.  If a field is not present in `fields` it was left unchanged; if it is present in `fields` and has a value of `undefined` it was removed from the document.  If `_id` is present it is ignored.
   */changed: function (collectionName, id, fields) {                                                                 // 1259
    var self = this;                                                                                                  // 1269
   ...
   * @locus Server                                                                                                    // 1276
   * @memberOf Subscription                                                                                           // 1276
   * @instance                                                                                                        // 1276
   * @param {String} collection The name of the collection that the document has been removed from.                   // 1276
   * @param {String} id The ID of the document that has been removed.                                                 // 1276
   */removed: function (collectionName, id) {                                                                         // 1276
    var self = this;                                                                                                  // 1285
...
_.extend(Server.prototype, {                                                                                          // 1417
  /**                                                                                                                 // 1419
   * @summary Register a callback to be called when a new DDP connection is made to the server.                       // 1419
   * @locus Server                                                                                                    // 1419
   * @param {function} callback The function to call when a new DDP connection is established.                        // 1419
   * @memberOf Meteor                                                                                                 // 1419
   * @importFromPackage meteor                                                                                        // 1419
   */onConnection: function (fn) {                                                                                    // 1419
    var self = this;                                                                                                  // 1427
    return self.onConnectionHook.register(fn);                                                                        // 1428
  },                                                                                                                  // 1429
  /**                                                                                                                 // 1431
   * @summary Register a callback to be called when a new DDP message is received.                                    // 1431
   * @locus Server                                                                                                    // 1431
   * @param {function} callback The function to call when a new DDP message is received.                              // 1431
   * @memberOf Meteor                                                                                                 // 1431
   * @importFromPackage meteor                                                                                        // 1431
   */onMessage: function (fn) {                                                                                       // 1431
    var self = this;                                                                                                  // 1439
  ...
  /**                                                                                                                 // 1482
   * Register a publish handler function.                                                                             // 1482
   *                                                                                                                  // 1482
   * @param name {String} identifier for query                                                                        // 1482
   * @param handler {Function} publish handler                                                                        // 1482
   * @param options {Object}                                                                                          // 1482
   *                                                                                                                  // 1482
   * Server will call handler function on each new subscription,                                                      // 1482
   * either when receiving DDP sub message for a named subscription, or on                                            // 1482
   * DDP connect for a universal subscription.                                                                        // 1482
   *                                                                                                                  // 1482
   * If name is null, this will be a subscription that is                                                             // 1482
   * automatically established and permanently on for all connected                                                   // 1482
   * client, instead of a subscription that can be turned on and off                                                  // 1482
   * with subscribe().                                                                                                // 1482
   *                                                                                                                  // 1482
   * options to contain:                                                                                              // 1482
   *  - (mostly internal) is_auto: true if generated automatically                                                    // 1482
   *    from an autopublish hook. this is for cosmetic purposes only                                                  // 1482
   *    (it lets us determine whether to print a warning suggesting                                                   // 1482
   *    that you turn off autopublish.)                                                                               // 1482
   */ /**                                                                                                             // 1482
       * @summary Publish a record set.                                                                               // 1505
       * @memberOf Meteor                                                                                             // 1505
       * @importFromPackage meteor                                                                                    // 1505
       * @locus Server                                                                                                // 1505
       * @param {String|Object} name If String, name of the record set.  If Object, publications Dictionary of publish functions by name.  If `null`, the set has no name, and the record set is automatically sent to all connected clients.
       * @param {Function} func Function called on the server each time a client subscribes.  Inside the function, `this` is the publish handler object, described below.  If the client passed arguments to `subscribe`, the function is called with the same arguments.
       */publish: function (name, handler, options) {                                                                 // 1505
    var self = this;                                                                                                  // 1514
                                                                                                                      // 1514
  ...
  /**                                                                                                                 // 1579
   * @summary Defines functions that can be invoked over the network by clients.                                      // 1579
   * @locus Anywhere                                                                                                  // 1579
   * @param {Object} methods Dictionary whose keys are method names and values are functions.                         // 1579
   * @memberOf Meteor                                                                                                 // 1579
   * @importFromPackage meteor                                                                                        // 1579
   */methods: function (methods) {                                                                                    // 1579
    var self = this;                                                                                                  // 1587
                                                                                                                      // 1587
