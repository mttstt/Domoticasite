...
/**                                                                                                                  // 5
 * @namespace Accounts                                                                                               // 5
 * @summary The namespace for all server-side accounts-related methods.                                              // 5
...
/**                                                                                                                  // 15
 * @summary A [Mongo.Collection](#collections) containing user documents.                                            // 15
 * @locus Anywhere                                                                                                   // 15
 * @type {Mongo.Collection}                                                                                          // 15
 * @importFromPackage meteor                                                                                         // 15
*/                                                                                                                   // 15
...
var AccountsCommon = function () {                                                                                   // 1
  function AccountsCommon(options) {                                                                                 // 11
     ...
     * @summary Get the current user id, or `null` if no user is logged in. A reactive data source.                  // 45
     * @locus Anywhere                                                                                               // 45
     */                                                                                                              // 45
                                                                                                                     // 45
  AccountsCommon.prototype.userId = function () {                                                                    // 45
    function userId() {                                                                                              //
    ...
    return userId;                                                                                                   // 51
        ...
        * @summary Get the current user record, or `null` if no user is logged in. A reactive data source.           // 53
        * @locus Anywhere                                                                                            // 53
        */                                                                                                           // 53
                                                                                                                     // 53
  AccountsCommon.prototype.user = function () {                                                                      // 53
    function user() {                                                                                                //
      ...
      return userId ? this.users.findOne(userId) : null;                                                             // 59
                                                                                                                     ...
                                                                                                                     // 60
    return user;                                                                                                     // 60
  }(); // Set up config for the accounts system. Call this on both the client                                        // 60
  // and the server.                                                                                                 // 63
  //                                                                                                                 // 64
  ...
  /**                                                                                                                // 96
   * @summary Set global accounts options.                                                                           // 96
   * @locus Anywhere                                                                                                 // 96
   * @param {Object} options                                                                                         // 96
   ...
   */                                                                                                                // 96
                                                                                                                     // 96
  AccountsCommon.prototype.config = function () {                                                                    // 96
    ...
    return config;                                                                                                   // 157
        ...
        * @summary Register a callback to be called after a login attempt succeeds.                                  // 159
        * @locus Anywhere                                                                                            // 159
        * @param {Function} func The callback to be called when login is successful.                                 // 159
        */                                                                                                           // 159
                                                                                                                     // 159
  AccountsCommon.prototype.onLogin = function () {                                                                   // 159
    ...
    return onLogin;                                                                                                  // 166
        ...
        * @summary Register a callback to be called after a login attempt fails.                                     // 168
        * @locus Anywhere                                                                                            // 168
        * @param {Function} func The callback to be called after the login has failed.                               // 168
        */                                                                                                           // 168
                                                                                                                     // 168
  AccountsCommon.prototype.onLoginFailure = function () {                                                            // 168
    function onLoginFailure(func) {                                                                                  //
      return this._onLoginFailureHook.register(func);                                                                // 174
    }                                                                                                                // 175
                                                                                                                     // 175
    return onLoginFailure;                                                                                           // 175
  }(); /**                                                                                                           // 175
        * @summary Register a callback to be called after a logout attempt succeeds.                                 // 177
        * @locus Anywhere                                                                                            // 177
        * @param {Function} func The callback to be called when logout is successful.                                // 177
        */                                                                                                           // 177
                                                                                                                     // 177
  AccountsCommon.prototype.onLogout = function () {                                                                  // 177
    ...
    return onLogout;                                                                                                 // 184
                                                                                                                     ...
                                                                                                                     // 184
  AccountsCommon.prototype._initConnection = function () {                                                           // 184
    function _initConnection(options) {                                                                              //
      ...
      if (options.connection) {                                                                                      // 199
        ...
        this.connection = Meteor.connection;                                                                         // 215
                                                                                                                     ...
                                                                                                                     // 217
    return _initConnection;                                                                                          // 217
  }();                                                                                                               // 217
                                                                                                                     // 217
  AccountsCommon.prototype._getTokenLifetimeMs = function () {                                                       // 217
    function _getTokenLifetimeMs() {                                                                                 //
      ...
      return (loginExpirationInDays || DEFAULT_LOGIN_EXPIRATION_DAYS) * 24 * 60 * 60 * 1000;                         // 227
                                                                                                                     ...
                                                                                                                     // 229
    return _getTokenLifetimeMs;                                                                                      // 229
  }();                                                                                                               // 229
                                                                                                                     // 229
  AccountsCommon.prototype._getPasswordResetTokenLifetimeMs = function () {                                          // 229
    function _getPasswordResetTokenLifetimeMs() {                                                                    //
      return (this._options.passwordResetTokenExpirationInDays || DEFAULT_PASSWORD_RESET_TOKEN_EXPIRATION_DAYS) * 24 * 60 * 60 * 1000;
                                                                                                                     ...
                                                                                                                     // 234
    return _getPasswordResetTokenLifetimeMs;                                                                         // 234
  }();                                                                                                               // 234
                                                                                                                     // 234
  AccountsCommon.prototype._getPasswordEnrollTokenLifetimeMs = function () {                                         // 234
    function _getPasswordEnrollTokenLifetimeMs() {                                                                   //
      return (this._options.passwordEnrollTokenExpirationInDays || DEFAULT_PASSWORD_ENROLL_TOKEN_EXPIRATION_DAYS) * 24 * 60 * 60 * 1000;
                                                                                                                     ...
                                                                                                                     // 239
    return _getPasswordEnrollTokenLifetimeMs;                                                                        // 239
  }();                                                                                                               // 239
                                                                                                                     // 239
  AccountsCommon.prototype._tokenExpiration = function () {                                                          // 239
    function _tokenExpiration(when) {                                                                                //
      ...
      return new Date(new Date(when).getTime() + this._getTokenLifetimeMs());                                        // 244
                                                                                                                     ...
                                                                                                                     // 245
    return _tokenExpiration;                                                                                         // 245
  }();                                                                                                               // 245
                                                                                                                     // 245
  AccountsCommon.prototype._tokenExpiresSoon = function () {                                                         // 245
    function _tokenExpiresSoon(when) {                                                                               //
      ...
      return new Date() > new Date(when) - minLifetimeMs;                                                            // 252
                                                                                                                     ...
                                                                                                                     // 253
    return _tokenExpiresSoon;                                                                                        // 253
  }();                                                                                                               // 253
                                                                                                                     // 253
  return AccountsCommon;                                                                                             // 253
}();                                                                                                                 // 253
                                                                                                                     // 253
...
/**                                                                                                                  // 261
 * @summary Get the current user id, or `null` if no user is logged in. A reactive data source.                      // 261
 * @locus Anywhere but publish functions                                                                             // 261
 * @importFromPackage meteor                                                                                         // 261
 */                                                                                                                  // 261
                                                                                                                     // 261
Meteor.userId = function () {                                                                                        // 266
  return Accounts.userId();                                                                                          // 267
}; /**                                                                                                               // 268
    * @summary Get the current user record, or `null` if no user is logged in. A reactive data source.               // 270
    * @locus Anywhere but publish functions                                                                          // 270
    * @importFromPackage meteor                                                                                      // 270
    */                                                                                                               // 270
                                                                                                                     // 270
...
var crypto = Npm.require('crypto');                                                                                  // 1
                                                                                                                     // 1
var AccountsServer = function (_AccountsCommon) {                                                                    // 1
  ...
  // @override of "abstract" non-implementation in accounts_common.js                                                // 69
                                                                                                                     // 69
                                                                                                                     // 69
  AccountsServer.prototype.userId = function () {                                                                    // 69
    function userId() {                                                                                              //
  ...
  ///                                                                                                                // 85
  /**                                                                                                                // 87
   * @summary Validate login attempts.                                                                               // 87
   * @locus Server                                                                                                   // 87
   * @param {Function} func Called whenever a login is attempted (either successful or unsuccessful).  A login can be aborted by returning a falsy value or throwing an exception.
   */                                                                                                                // 87
                                                                                                                     // 87
  AccountsServer.prototype.validateLoginAttempt = function () {                                                      // 87
    function validateLoginAttempt(func) {                                                                            //
      ...
      return this._validateLoginHook.register(func);                                                                 // 94
                                                                                                                     ...
                                                                                                                     // 95
    return validateLoginAttempt;                                                                                     // 95
  }(); /**                                                                                                           // 95
        * @summary Set restrictions on new user creation.                                                            // 97
        * @locus Server                                                                                              // 97
        * @param {Function} func Called whenever a new user is created. Takes the new user object, and returns true to allow the creation or false to abort.
        */                                                                                                           // 97
                                                                                                                     // 97
  AccountsServer.prototype.validateNewUser = function () {                                                           // 97
    function validateNewUser(func) {                                                                                 //
      this._validateNewUserHooks.push(func);                                                                         // 103
    }                                                                                                                // 104
                                                                                                                     // 104
    return validateNewUser;                                                                                          // 104
  }(); ///                                                                                                           // 104
  /// CREATE USER HOOKS                                                                                              // 107
  ///                                                                                                                // 108
  /**                                                                                                                // 110
   * @summary Customize new user creation.                                                                           // 110
   * @locus Server                                                                                                   // 110
   * @param {Function} func Called whenever a new user is created. Return the new user object, or throw an `Error` to abort the creation.
   */                                                                                                                // 110
                                                                                                                     // 110
  AccountsServer.prototype.onCreateUser = function () {                                                              // 110
    function onCreateUser(func) {                                                                                    //
      ...
      this._onCreateUserHook = func;                                                                                 // 120
                                                                                                                     ...
                                                                                                                     // 121
    return onCreateUser;                                                                                             // 121
  }(); /**                                                                                                           // 121
        * @summary Customize oauth user profile updates                                                              // 123
        * @locus Server                                                                                              // 123
        ...
        */                                                                                                           // 123
                                                                                                                     // 123
  AccountsServer.prototype.onExternalLogin = function () {                                                           // 123
    function onExternalLogin(func) {                                                                                 //
      ...
      this._onExternalLoginHook = func;                                                                              // 133
                                                                                                                     ...
                                                                                                                     // 134
    return onExternalLogin;                                                                                          // 134
  }();                                                                                                               // 134
                                                                                                                     // 134
  return AccountsServer;                                                                                             // 134
}(AccountsCommon);                                                                                                   // 134
                                                                                                                     //
;                                                                                                                    // 136
